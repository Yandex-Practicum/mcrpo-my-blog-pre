...
public class PostDaoImpl implements PostDao {
    ...
    public void delete(Long id) {
        ...
        String deleteTags = "DELETE FROM post_tags WHERE post_id = ?";
        jdbcTemplate.update(deleteTags, id);

        String deleteImages = "DELETE FROM post_images WHERE post_id = ?";
        jdbcTemplate.update(deleteImages, id);
