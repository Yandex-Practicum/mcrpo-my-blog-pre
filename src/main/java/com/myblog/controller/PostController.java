...
public class PostController {
    ...
    public ResponseEntity<Post> updatePost(
        ...
        try {
            ...
            log.debug("Post not found for update: {}", id);
    ...
    public ResponseEntity<Void> deletePost(@PathVariable Long id) {
        ...
        try {
            ...
            log.debug("Post not found for delete: {}", id);
            return ResponseEntity.notFound().build();
        }
    }
    ...
    public ResponseEntity<Integer> incrementLikes(@PathVariable Long id) {
        ...
        try {
            ...
            log.debug("Post not found for like increment: {}", id);
            return ResponseEntity.notFound().build();
        }
    }
    ...
    public ResponseEntity<Integer> removeLike(@PathVariable Long id) {
        ...
        try {
            ...
            log.debug("Post not found for like decrement: {}", id);
            return ResponseEntity.notFound().build();
        }
    }
    ...
    public ResponseEntity<Void> uploadImage(
        ...
        try {
            ...
            log.debug("Post not found for image upload: {}", id);
            return ResponseEntity.notFound().build();
        } catch (IOException e) {
